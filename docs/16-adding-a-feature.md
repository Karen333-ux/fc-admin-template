...
## 🚦 قبل ما تفتح الملف ده أصلاً

الوصفة دي بتفترض إن حاجتين خلصوا. لو واحدة منهم لسه، **الوصفة مش هتشتغل معاك**:

### ١. بوابة أسبوع ٠ — مراجعة التصميم

`docs/19-policies.md` و`docs/20-security.md` **بوابة تصميم إلزامية قبل أي كود** — مش قراءة
أسبوع ١. الفريق بيقراهم ويعمل مراجعة بصوت عالي، وأي سؤال مالوش إجابة بيتحوّل لـ ADR في
`docs/21-decisions.md` **قبل** ما حد يكتب سطر.

> ليه؟ لأن أول مراجعة جدّية للوثائق دي كشفت **١٣ تناقض** بينها وبين بعضها — منهم اتنين
> كانوا هيقفلوا اللوحة على كل المستخدمين. المراجعة على الورق أرخص من المراجعة بعد ٦ سياقات.

### ٢. الشريحة الرأسية الأولى

**أول ميزة في المشروع مش بتتبني بالوصفة دي.** هي `docs/23-slice-01-identity.md` —
شريحة مصمّمة عشان **تثبت أو تكسر** العقود في `docs/19` و`docs/20` قبل ما أي سياق تاني يتبني.

الوصفة دي بتشتغل **بعد** ما الشريحة دي تعدّي بوابة مراجعة العقود بتاعتها. قبل كده،
الأساس اللي الوصفة بتقف عليه لسه ماتجربش. (ADR-013)

> 🧪 **تجربة الساعة** — «مطوّر من بره الفريق يضيف ميزة كاملة بالوثائق في ساعة» — مجدولة
> **أسبوع ٢**، مش أسبوع ٦. في أسبوع ٢ نتيجتها قرار؛ في أسبوع ٦ نتيجتها تقرير.
