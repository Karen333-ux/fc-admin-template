...
use Src\Support\Infrastructure\Filesystem\TenantAwarePathGenerator;
...
return [
     ...
     */
    // Media Library **Pro** مش متثبّت (باكدج مدفوع)، فالكلاس ده مش موجود.
    // سيبناه كنص بدل ما يشاور على كلاس غير موجود — نفس اللي عملناه مع
    // Spatie\LaravelData في config/settings.php.
